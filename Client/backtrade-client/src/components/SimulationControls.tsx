...
interface SimulationControlsProps {
  onSimulationStateFlip: () => void
}

const SimulationControls = (props: SimulationControlsProps): JSX.Element => {

  return <Paper className="controls-card even-margin">
    ...
    <div>
      <div className="panel">
        <div>
          ...
          <IconButton className="speed-control-button" onClick={props.onSimulationStateFlip}>
